...
class SchemaValidator:
    ...
    def _load_template(self):
        ...
        try:
            with open(self.schema_template_path, encoding="utf-8") as f:
            ...
            raise ValueError(f"Invalid JSON in schema template: {e}")
    ...
    def validate(self, config: Dict[str, Any], verbose: bool = True) -> List[str]:
        ...
        try:
            ...
            error_msg = f"Schema validation error: {e!s}"
            errors.append(error_msg)
            if verbose:
                print(error_msg)
...
def validate_episim_config_safe(
    config: Dict[str, Any],
    verbose: bool = True,
) -> tuple[bool, List[str]]:
    """
