...
class TestSchemaValidator:
    ...
    def test_generate_schema_different_group_sizes(self):
        ...
        assert schema_2["properties"]["epidemic_params"]["properties"]["ηᵍ"]["minItems"] == 2
        assert schema_2["properties"]["epidemic_params"]["properties"]["ηᵍ"]["maxItems"] == 2
        
        # Test with group size 4
        schema_4 = validator.generate_schema(4)
        assert schema_4["properties"]["epidemic_params"]["properties"]["ηᵍ"]["minItems"] == 4
        assert schema_4["properties"]["epidemic_params"]["properties"]["ηᵍ"]["maxItems"] == 4
...
class TestEpiSimSchemaValidator:
    ...
    def test_validate_config_safe_invalid(self, minimal_config):
        ...
        invalid_config = minimal_config.copy()
        invalid_config["epidemic_params"]["ηᵍ"] = [0.3, 0.3]  # Only 2 values instead of 3
    ...
    def test_get_schema_for_config(self, minimal_config):
        ...
        assert schema["properties"]["epidemic_params"]["properties"]["ηᵍ"]["minItems"] == 3
        assert schema["properties"]["epidemic_params"]["properties"]["ηᵍ"]["maxItems"] == 3
...
class TestEpiSimConfigIntegration:
    ...
    def test_episim_config_schema_unavailable_warning(self, minimal_config, capsys):
        ...
        assert "Warning: JSON schema validation requested but jsonschema package not available" in captured.out
